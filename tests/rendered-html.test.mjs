...
test("server-renders the complete V3 advertising strategy", async () => {
  ...
  assert.equal((casesHtml.match(/class="gbsCasePhase"/g) ?? []).length, 13); // WPP 2 + L’Oréal 2 + Goodtake 4 + Tec-do 2 + AppLovin 3
  ...
  assert.match(html, /id="gbs-usage"[\s\S]*100k\+ video ads a day[\s\S]*doubling every month/);
