      ...
      <section className="marketHero marketFlowPage" id="market">
        <div className="marketFlowShell">
          ...
          <section className="marketFlowAiBand" aria-label="2026 到 2030 AI 价值捕获">
            ...
            <div className="marketFlowYear future"><header><strong>2030</strong><span>FORECAST</span></header><div className="marketFlowYearTotal"><span><span className="langZh">可替代劳动力盘</span><span className="langEn">Replaceable labor pool</span></span><b>≈ $50B</b></div><div className="marketFlowMetric api marketFlowMetricCombined"><span><span className="langZh">视频 + 图片 AI 整体 · AGENT + MODEL API</span><span className="langEn">VIDEO + IMAGE AI · AGENT + MODEL API</span></span><b>$29.4B</b><small>9.8×</small></div></div>
